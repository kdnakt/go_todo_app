...
import (
	...
	"github.com/kdnakt/go_todo_app/testutil/fixture"
...
func TestJWTer_GetToken(t *testing.T) {
	...
	want, err := jwt.NewBuilder().
		...
		Issuer(`github.com/kdnakt/go_todo_app`).
	...
	ctx := context.Background()
	moq := &StoreMock{}
	moq.LoadFunc = func(ctc context.Context, key string) (entity.UserID, error) {
		return userID, nil
	}
